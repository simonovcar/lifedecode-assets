(function () {
  ...
  const CFG = {
    VERSION: "lifedecode-app-v9-redesign",
    ...
    // Support widget contact channels.
    SUPPORT_EMAIL: "simon.ovcar12@gmail.com",
...
:root{
  ...
  --ldw-container:min(1180px, calc(100% - 32px));
  --ldw-radius-lg:26px;
  --ldw-radius-md:18px;
  --ldw-radius-sm:12px;
  --ldw-header-h:64px;
...
/* Hero */
.ldw_hero{position:relative;margin-top:clamp(14px,2.4vw,22px);border-radius:var(--ldw-radius-lg);overflow:hidden;min-height:clamp(440px,72vh,700px);display:flex;align-items:flex-end;justify-content:center;text-align:center;padding:clamp(22px,4vw,52px) clamp(18px,4vw,44px);border:1px solid rgba(225,158,255,.16);box-shadow:0 30px 90px rgba(0,0,0,.45);}
...
.ldw_hero_inner{position:relative;z-index:1;width:min(560px,100%);}
.ldw_badge{display:inline-flex;align-items:center;justify-content:center;margin:0 0 12px;padding:7px 13px;border-radius:999px;border:1px solid rgba(255,255,255,.16);background:rgba(20,10,34,.5);color:#fff;font-size:10.5px;font-weight:900;letter-spacing:.14em;text-transform:uppercase;backdrop-filter:blur(6px);}
.ldw_title{margin:0 auto 12px;font-family:Orbitron,Inter,system-ui,sans-serif;font-size:clamp(30px,5vw,58px);font-weight:900;line-height:.94;letter-spacing:-.03em;text-shadow:0 10px 34px rgba(0,0,0,.66);}
...
.ldw_sub{max-width:460px;margin:0 auto;color:rgba(250,245,255,.90);font-size:clamp(13.5px,1.05vw,16px);line-height:1.55;text-shadow:0 3px 14px rgba(0,0,0,.75);}
.ldw_actions{display:flex;flex-wrap:wrap;gap:10px 12px;align-items:center;justify-content:center;margin-top:20px;}
.ldw_enter{min-height:50px;padding:0 24px;border-radius:999px;font-size:13.5px;}
.ldw_hero_secondary{background:transparent;border:1px solid rgba(255,255,255,.24);}
.ldw_micro{margin:14px auto 0;color:rgba(255,255,255,.62);font-size:11px;font-weight:700;letter-spacing:.06em;}
...
/* Sections */
.ldw_section{padding:clamp(46px,7vw,84px) 0;border-top:1px solid rgba(255,255,255,.05);}
...
.ldw_feature{background:rgba(9,6,20,.55);padding:22px 22px 24px;}
...
/* Explore the world */
.ldw_rooms{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;}
.ldw_room{position:relative;border-radius:var(--ldw-radius-md);padding:20px 18px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);overflow:hidden;}
...
.ldw_npcs{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;margin-top:clamp(28px,4vw,36px);}
.ldw_npc{position:relative;border-radius:var(--ldw-radius-md);padding:20px 18px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);}
...
/* Cosmetics */
.ldw_cosmetics{display:grid;grid-template-columns:1.1fr .9fr;gap:clamp(24px,4vw,48px);align-items:center;}
...
/* World showcase */
.ldw_showcase{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;}
.ldw_showcase_tile{aspect-ratio:16/10;border-radius:var(--ldw-radius-md);border:1px dashed rgba(255,255,255,.16);background:repeating-linear-gradient(135deg,rgba(255,255,255,.025) 0 12px,rgba(255,255,255,.05) 12px 24px);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;color:rgba(255,255,255,.42);}
.ldw_showcase_tile svg{width:22px;height:22px;opacity:.6;}
.ldw_showcase_tile span{font-size:11px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;}
@media(max-width:820px){.ldw_showcase{grid-template-columns:repeat(2,1fr);}}
@media(max-width:560px){.ldw_showcase{grid-template-columns:1fr;}}
...
.ldw_support_panel{width:min(300px,calc(100vw - 32px));border-radius:var(--ldw-radius-md);border:1px solid rgba(225,158,255,.18);background:linear-gradient(165deg,rgba(20,14,32,.97),rgba(6,5,14,.98));box-shadow:0 26px 70px rgba(0,0,0,.5);padding:18px;transform:translateY(8px) scale(.98);opacity:0;pointer-events:none;transition:opacity .16s ease,transform .16s ease;}
.ldw_support.open .ldw_support_panel{opacity:1;transform:translateY(0) scale(1);pointer-events:auto;}
.ldw_support_head{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin-bottom:6px;}
.ldw_support_panel h3{margin:0;font-size:14.5px;line-height:1.3;}
.ldw_support_panel p{margin:0 0 14px;color:var(--ld-muted);font-size:12.5px;line-height:1.5;}
.ldw_support_close{min-height:26px;min-width:26px;padding:0;border-radius:9px;flex-shrink:0;font-size:13px;}
.ldw_support_actions{display:grid;gap:8px;}
.ldw_support_actions .ldw_btn,.ldw_support_actions .ldw_linkbtn{min-height:42px;font-size:12px;width:100%;}
@media(prefers-reduced-motion:reduce){.ldw_support_toggle,.ldw_support_panel{transition:none;}}
@media(max-width:480px){.ldw_support{right:12px;bottom:12px;}.ldw_support_toggle{width:48px;height:48px;}}
`;
...
<div class="ldw_shell">
  <main>
    ...
    <section class="ldw_section ldw_container" aria-label="World showcase">
      <div class="ldw_section_head">
        <div class="ldw_kicker">A peek inside</div>
        <h2>More of the world, coming into view</h2>
      </div>
      <div class="ldw_showcase">
        <div class="ldw_showcase_tile"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="9" cy="11" r="2"/><path d="M21 15l-4.5-4.5a2 2 0 0 0-2.8 0L7 17"/></svg><span>Screenshot coming soon</span></div>
        <div class="ldw_showcase_tile"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="9" cy="11" r="2"/><path d="M21 15l-4.5-4.5a2 2 0 0 0-2.8 0L7 17"/></svg><span>Screenshot coming soon</span></div>
        <div class="ldw_showcase_tile"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="9" cy="11" r="2"/><path d="M21 15l-4.5-4.5a2 2 0 0 0-2.8 0L7 17"/></svg><span>Screenshot coming soon</span></div>
      </div>
    </section>
    ...
    <section class="ldw_container" style="padding:0 0 clamp(46px,7vw,84px);">
...
<div class="ldw_support" id="ldw_support">
  <div class="ldw_support_panel" id="ldw_support_panel" role="dialog" aria-modal="false" aria-labelledby="ldw_support_title">
    <div class="ldw_support_head">
      <h3 id="ldw_support_title">Need help entering the world?</h3>
      <button class="ldw_btn ldw_support_close" id="ldw_support_close" type="button" aria-label="Close support panel">&#10005;</button>
    </div>
    <p>Send us a message and we'll get back to you.</p>
    <div class="ldw_support_actions" id="ldw_support_actions">
      <a class="ldw_btn ldw_btn_primary" id="ldw_support_email" href="mailto:${CFG.SUPPORT_EMAIL}">Email Support</a>
    </div>
  </div>
  <button class="ldw_support_toggle" id="ldw_support_toggle" type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="ldw_support_panel" aria-label="Open support chat">
...
`;
  ...
  function bindSupportWidget() {
    ...
    const actions = document.getElementById("ldw_support_actions");
    if (!root || !toggle || !panel) return;

    if (CFG.SUPPORT_WHATSAPP_URL && actions) {
      const wa = document.createElement("a");
      wa.className = "ldw_btn ldw_btn_ghost_sm";
      wa.id = "ldw_support_whatsapp";
