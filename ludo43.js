  ...
  <details class="ld_public_accordion" aria-label="About LifeDecode AI">
    ...
    <div class="ld_public_body">
      <div class="ld_public_inner">
        <h1>LifeDecode AI</h1>
        <p>LifeDecode AI is an AI-powered self-development and emotional clarity platform. It helps users reflect on daily check-ins, decode emotional triggers, understand patterns, generate practical plans, and get support tools for moments of stress, urges, overthinking, or personal confusion.</p>
        <div class="ld_public_grid">
          <div class="ld_public_card"><b>AI self-development tools</b><p>Users can create check-ins, generate short action plans, decode triggers, and use guided reflection tools to better understand their behaviour and emotional state.</p></div>
          <div class="ld_public_card"><b>Emergency support flow</b><p>The app includes an emergency reset button and calm-down protocol designed to help users slow down, reflect, and choose a safer next step.</p></div>
          <div class="ld_public_card"><b>Screenshot and pattern decoding</b><p>LifeDecode can help users analyze confusing messages, emotional patterns, and relationship dynamics in a structured AI-supported way.</p></div>
        </div>
        <div class="ld_public_data">
          <p><strong style="color:#fff;">Why LifeDecode requests user data:</strong> LifeDecode uses basic account information such as email, profile name, login provider, and session data to authenticate users, keep accounts secure, save progress, sync features across devices, prevent abuse, and provide personalized app functionality. Users can also voluntarily submit text, check-ins, screenshots, and reflections so the app can generate relevant AI-supported responses.</p>
        </div>
...
<button data-open="screenshot">🖼️ SCREENSHOT DECODER <small>Upload a screenshot • Get the read instantly</small></button>
    ...
    <div class="ld_panel" id="ld_center">
      <div class="hero">
        ...
        <div class="ld_sub" id="ld_subline">
         A sharp AI companion for check-ins, emotional clarity, screenshot decoding, and the right next move when your head gets loud.
        </div>
...
<div id="ld_badge" aria-label="Version badge">
  <span id="ld_badge_text"> AI v1</span>
      ...
      openSheet(
        ...
        <div class="ld_help_shell">
          ...
          <div class="ld_help_grid">
            ...
            <div class="ld_help_card"><b>Emergency Button</b><p>Use this when your head is loud and you need a fast reset now.</p></div>
            <div class="ld_help_card"><b>Generate Plan</b><p>Get a clear AI action plan for the next 12 hours.</p></div>
            <div class="ld_help_card"><b>Decode Trigger</b><p>Break down what triggered you and what your smartest next move is.</p></div>
            <div class="ld_help_card"><b>Screenshot Decoder</b><p>Upload a chat screenshot and get the signal, meaning, flags, and next move.</p></div>
            <div class="ld_help_card"><b>Premium</b><p>Unlock deeper AI outputs, saved tools, extra modules, and faster access.</p></div>
          </div>
        </div>
      `
      );
