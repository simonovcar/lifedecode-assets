console.log("[LD] SINGLE FILE PARSED");
  ...
  <div id="ld_grid">
    <div class="ld_panel" id="ld_left">
      <div class="hd">
        ...
        <div class="ld_badge"><span class="ld_dot ok"></span> Account Mode</div>
      </div>
      <div class="bd">
        <div class="ld_nav" id="ld_nav">
          ...
          <button data-open="settings">⚙️ Settings <small>Theme + data</small></button>
...
<div id="ld_badge" aria-label="Version badge">
  <span id="ld_badge_text">LD Recovery • v4.0 • Single File Mode</span>
