...
#ld_game_fullscreen.active{
  display:block;
}

#ld_game_fullscreen canvas{
...
const fs = document.getElementById("ld_game_fullscreen");
const canvasFS = document.getElementById("ld_game_canvas_full");

function startGameFullscreen(){
  fs.classList.add("active");

  // resize canvas
  canvasFS.width = window.innerWidth;
  canvasFS.height = window.innerHeight;

  startGame(canvasFS); // VERY IMPORTANT → pass canvas
}

document.getElementById("ld_game_exit").onclick = () => {
