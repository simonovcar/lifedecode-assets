...
/* ===== VELVYRIA WORLD CTA + COLLAPSIBLE PUBLIC INFO + WORDMARK V2 ===== */
.ld_public_accordion{
  padding:0;
  overflow:hidden;
  margin:0 auto var(--gap);
...
.ld_public_summary::-webkit-details-marker{display:none;}

.ld_public_summary_left{
  display:flex;
  flex-direction:column;
  gap:4px;
  min-width:0;
...
.ld_public_summary .ld_public_kicker{margin:0;}

.ld_public_summary_title{
...
.ld_public_summary_badge{
  ...
  padding:10px 14px;
  border-radius:999px;
  border:1px solid rgba(180,138,255,.24);
...
.ld_public_accordion[open] .ld_public_summary_badge{color:#fff;border-color:rgba(222,190,255,.38);}
.ld_public_accordion[open] .ld_public_summary_badge::before{content:"CLOSE ";}
.ld_public_accordion:not([open]) .ld_public_summary_badge::before{content:"";}

.ld_public_body{
  padding:0 clamp(20px,3vw,34px) clamp(20px,3vw,34px);
  border-top:1px solid rgba(185,145,255,.12);
}

.ld_brand_wordmark{
  gap:14px;
  padding:6px 14px 12px;
  filter:drop-shadow(0 18px 28px rgba(117,76,255,.18));
}
...
.ld_brand_wordmark_main{
  ...
  background:linear-gradient(92deg, #ffffff 0%, #bcd2ff 16%, #7f7aff 42%, #b65cff 70%, #ff9df5 100%) !important;
...
.ld_brand_wordmark_sub{
  font-size:clamp(18px,2.35vw,32px) !important;
...
.ld_brand_wordmark::before{
  ...
  background:linear-gradient(90deg, transparent, rgba(126,145,255,.42), rgba(238,128,255,.42), transparent) !important;
}

.ld_brand_wordmark::after{
  width:min(680px, 86vw) !important;
  height:100px !important;
  background:radial-gradient(ellipse at center, rgba(119,76,255,.25), rgba(217,91,255,.10) 38%, transparent 72%) !important;
}
...
#ld_btn_world.ld_btn.world{
  ...
  gap:4px;
  background:
    radial-gradient(120% 220% at 0% 0%, rgba(56,215,255,.26), transparent 42%),
    radial-gradient(120% 220% at 100% 0%, rgba(255,79,216,.26), transparent 44%),
    linear-gradient(135deg, rgba(113,72,255,.98), rgba(183,72,255,.88) 48%, rgba(34,211,238,.80));
  border:1px solid rgba(255,255,255,.28);
  box-shadow:
    0 24px 52px rgba(119,76,255,.34),
    0 0 42px rgba(56,215,255,.16),
    inset 0 1px 0 rgba(255,255,255,.20);
  animation:ldWorldPulse 2.8s ease-in-out infinite;
}
...
#ld_btn_world.ld_btn.world::before{
  ...
  position:absolute;
  inset:-2px;
  background:linear-gradient(110deg, transparent 0%, rgba(255,255,255,.20) 42%, transparent 58%);
  transform:translateX(-120%);
  animation:ldWorldSweep 3.2s ease-in-out infinite;
  pointer-events:none;
}
...
#ld_btn_world.ld_btn.world:hover{
  transform:translateY(-2px) scale(1.01);
  border-color:rgba(255,255,255,.44);
  box-shadow:0 30px 70px rgba(119,76,255,.42),0 0 54px rgba(56,215,255,.22),inset 0 1px 0 rgba(255,255,255,.24);
}

@keyframes ldWorldSweep{
  0%, 38%{transform:translateX(-130%);}
  68%,100%{transform:translateX(130%);}
}

@keyframes ldWorldPulse{
  0%,100%{box-shadow:0 24px 52px rgba(119,76,255,.34),0 0 42px rgba(56,215,255,.16),inset 0 1px 0 rgba(255,255,255,.20);}
  50%{box-shadow:0 30px 64px rgba(119,76,255,.44),0 0 58px rgba(56,215,255,.24),inset 0 1px 0 rgba(255,255,255,.24);}
}

@media (max-width:560px){
  .ld_public_summary{padding:14px;align-items:flex-start;}
  .ld_public_summary_badge{min-height:34px;padding:8px 10px;font-size:9px;}
  .ld_public_body{padding:0 14px 16px;}
  .ld_brand_wordmark_main{font-size:clamp(26px,8.5vw,42px) !important;letter-spacing:.055em !important;}
  .ld_brand_wordmark_sub{font-size:clamp(12px,3.7vw,18px) !important;letter-spacing:.14em !important;}
  #ld_btn_world.ld_btn.world{min-height:72px;border-radius:22px;padding-right:46px;}
  .ld_world_btn_main{font-size:13px;letter-spacing:.055em;}
  .ld_world_btn_sub{font-size:10px;}
}
...
<div id="ld_shell">
  ...
  <details class="ld_public_homepage ld_public_accordion" aria-label="About LifeDecode">
    <summary class="ld_public_summary">
    ...
    <div class="ld_public_body">
      <h1>LifeDecode AI</h1>
      <p>
        LifeDecode AI is an AI-powered self-development and emotional clarity platform. It helps users reflect on daily check-ins, decode emotional triggers, understand patterns, generate practical plans, and get support tools for moments of stress, urges, overthinking, or personal confusion.
      </p>
      ...
      <div class="hero">
        ...
        <div class="ld_sub" id="ld_subline">
         A sharp AI companion for check-ins, emotional clarity, screenshot decoding, and the right next move when your head gets loud.
          ...
          <button class="ld_btn world" id="ld_btn_world" type="button"><span class="ld_world_btn_main">ENTER VELVYRIA WORLD</span><span class="ld_world_btn_sub">Open the interactive LifeDecode world</span></button>
        </div>
      </div>
