...
${ctx || "General screenshot decode."}`;
    ...
    async function generateScreenshotDecode({ imageDataUrl, context, tone, previewOnly }) {
      ...
      const payload = {
        ...
        prompt: `You are LifeDecode Screenshot Decoder AI. Analyze the uploaded screenshot directly. Most screenshots will be chats or messages.
...
GOAL:
Give a sharp, charismatic, socially smart read. Be funny or viral only when the screenshot clearly allows it. Be serious when the screenshot is serious. Keep it concise.
...
End with one short unlock tease.
Keep total length around 60-90 words.
...
FLAGS:
[3 short bullet lines max]

NEXT MOVE:
[2-3 short lines]

REPLY:
[1 concise reply only if useful]
...
- Do not mention tone modes
- Never say you cannot read the screenshot unless it is actually unreadable.`
      };
      const reply = await callMake(payload);
      return String(reply || "").trim();
    }
      ...
      openSheet(
        ...
        <div class="ld_sd_shell">
          <div class="ld_sd_hero">
            ...
            <div class="ld_sd_sub">Upload a screenshot and get a clean read on the vibe, intent, red flags, and your best next move.</div>
          </div>
              ...
              <div class="bd">
                <label class="ld_sd_upload ${shot.lastImageData ? "has-image" : ""}" id="ld_sd_upload_box">
                  ...
                  <div class="ld_sd_uploadInner">
                    ...
                    <div class="ld_sd_title" style="font-size:18px;margin:0;">Choose a screenshot</div>
                    <div class="ld_sd_sub" style="max-width:34ch;">Best for chats, texts, DMs, and unclear conversations.</div>
                  </div>
                ...
                <div class="ld_hint" id="ld_sd_hint">Free preview left today: ${Math.max(0, 1 - (previewWindow.fp.used || 0))}. Unlock gives the full read + suggested reply.</div>
              </div>
            </div>
            ...
            <div class="ld_sd_output">
              <div class="ld_sd_outputBody">
                ...
                <div class="ld_sd_locked" id="ld_sd_locked_box">
                  <div class="ld_notice"><strong>Unlock the full decode</strong><br>Get the full meaning, key signal, best next move, and a reply suggestion.</div>
