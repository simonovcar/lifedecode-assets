...
/* ===== LIFEDECODE WORLD ICONIC LANDING PATCH v1 ===== */
:root{--ld-iconic-url:url("https://cdn.jsdelivr.net/gh/simonovcar/lifedecode-assets@main/iconic.png?v=world-iconic-1");}
body{background:#03020a !important;}
#ld_bg{background:#03020a !important;overflow:hidden;}
#ld_bg::before{content:"";position:absolute;inset:0;background-image:linear-gradient(180deg,rgba(3,2,10,.20),rgba(3,2,10,.72) 62%,rgba(3,2,10,.92)),radial-gradient(900px 520px at 50% 10%,rgba(195,67,255,.22),transparent 62%),var(--ld-iconic-url);background-size:cover,cover,cover;background-position:center,center,center 45%;filter:saturate(1.1) contrast(1.06);opacity:.58;transform:scale(1.018);}
#ld_bg::after{content:"";position:absolute;inset:0;background:radial-gradient(ellipse at center,transparent 34%,rgba(3,2,10,.42) 72%,rgba(3,2,10,.85) 100%),linear-gradient(90deg,rgba(3,2,10,.86),transparent 24%,transparent 76%,rgba(3,2,10,.86));pointer-events:none;}
#ld_noise{opacity:.07;}#ld_glowgrid{opacity:.10;}
#ld_shell{padding-top:clamp(10px,1.6vw,22px);}
#ld_top{max-width:1320px;background:linear-gradient(180deg,rgba(9,6,24,.72),rgba(5,3,14,.58));border-color:rgba(217,105,255,.24);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);}
.ld_brand_wordmark_main{font-size:clamp(32px,4.2vw,58px);letter-spacing:.10em;background:linear-gradient(92deg,#ffffff 0%,#c9e8ff 20%,#9d6cff 48%,#ff69e6 76%,#ffffff 100%);-webkit-background-clip:text;background-clip:text;color:transparent;}
.ld_brand_wordmark_sub{font-size:clamp(15px,1.9vw,25px);letter-spacing:.24em;}
#ld_top_actions{max-width:850px;margin:0 auto;width:100%;}
#ld_top_actions .ld_btn{background:linear-gradient(180deg,rgba(18,10,40,.72),rgba(8,5,22,.72));border-color:rgba(211,148,255,.20);}
#ld_btn_upgrade{background:linear-gradient(135deg,rgba(155,72,255,.92),rgba(255,66,220,.58)) !important;box-shadow:0 18px 42px rgba(158,72,255,.22);}
.ld_top_legal_links{display:flex;justify-content:center;gap:10px;flex-wrap:wrap;margin-top:-2px;}
.ld_top_legal_links a{color:rgba(245,239,255,.72);text-decoration:none;font-size:11px;font-weight:900;letter-spacing:.13em;text-transform:uppercase;border:1px solid rgba(214,164,255,.14);background:rgba(255,255,255,.035);padding:8px 12px;border-radius:999px;}
.ld_top_legal_links a:hover{color:#fff;border-color:rgba(230,190,255,.30);background:rgba(255,255,255,.07);}
.ld_public_accordion{max-width:1320px;margin:0 auto 14px;border:1px solid rgba(214,164,255,.16);background:linear-gradient(180deg,rgba(10,6,25,.62),rgba(6,4,16,.50));backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);}
#ld_grid{max-width:1320px;grid-template-columns:1fr !important;}
#ld_left,#ld_right{display:none !important;}
#ld_center{border-radius:34px;border-color:rgba(222,119,255,.24);background:linear-gradient(180deg,rgba(9,5,24,.76),rgba(5,3,14,.66));backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);box-shadow:0 34px 100px rgba(0,0,0,.52),0 0 80px rgba(159,72,255,.14);}
#ld_center .hero{min-height:clamp(620px,72svh,860px);display:flex;flex-direction:column;align-items:center;justify-content:flex-end;text-align:center;padding:clamp(24px,4vw,46px);isolation:isolate;}
#ld_center .hero::before{content:"";position:absolute;inset:12px;border-radius:28px;background:linear-gradient(180deg,rgba(0,0,0,.02),rgba(4,2,12,.72) 66%,rgba(4,2,12,.92));z-index:-1;pointer-events:none;}
#ld_center .hero::after{content:"YEE-HAW • HMPH • ARRR • REALLY?";position:absolute;left:50%;top:22px;transform:translateX(-50%);width:min(760px,92%);padding:10px 14px;border-radius:999px;border:1px solid rgba(255,255,255,.13);background:rgba(4,2,12,.42);color:rgba(255,255,255,.74);font-size:11px;font-weight:950;letter-spacing:.20em;text-transform:uppercase;box-shadow:0 18px 45px rgba(0,0,0,.30);backdrop-filter:blur(10px);}
.ld_heroart{display:none !important;}
.ld_iconic_hero{position:absolute;inset:0;background-image:linear-gradient(180deg,rgba(3,2,10,.02),rgba(3,2,10,.10) 42%,rgba(3,2,10,.88) 92%),var(--ld-iconic-url);background-size:cover;background-position:center 42%;z-index:-2;opacity:.98;filter:saturate(1.12) contrast(1.05);}
.ld_world_badge_line{display:inline-flex;align-items:center;justify-content:center;margin-bottom:14px;padding:10px 14px;border-radius:999px;border:1px solid rgba(255,255,255,.18);background:linear-gradient(135deg,rgba(74,33,145,.62),rgba(255,68,222,.18));color:#fff;font-size:12px;font-weight:950;letter-spacing:.16em;text-transform:uppercase;box-shadow:0 0 28px rgba(205,72,255,.20);}
.ld_centerTitle{max-width:980px;margin:0 auto 14px;font-family:'Orbitron','Rajdhani',Inter,system-ui,sans-serif;font-size:clamp(38px,7vw,98px);font-weight:1000;line-height:.88;letter-spacing:-.06em;text-shadow:0 0 34px rgba(168,76,255,.38),0 10px 42px rgba(0,0,0,.70);}
.ld_centerTitle .grad{background:linear-gradient(92deg,#fff 0%,#b8eaff 22%,#a66cff 48%,#ff61df 76%,#fff 100%);-webkit-background-clip:text;background-clip:text;color:transparent;}
.ld_sub{max-width:820px;margin:0 auto;color:rgba(250,245,255,.88);font-size:clamp(15px,1.6vw,21px);line-height:1.48;text-shadow:0 4px 18px rgba(0,0,0,.80);}
.ld_world_microcopy{margin:14px auto 0;color:rgba(255,255,255,.70);font-size:12px;font-weight:850;letter-spacing:.09em;text-transform:uppercase;}
.ld_actionsRow_simple{width:min(760px,100%);margin-top:26px;gap:14px;}
#ld_btn_world.ld_btn.world{max-width:720px;min-height:92px;border-radius:30px;background:radial-gradient(120% 160% at 12% 0%,rgba(255,255,255,.24),transparent 34%),radial-gradient(120% 160% at 88% 0%,rgba(39,221,255,.28),transparent 38%),linear-gradient(135deg,rgba(119,54,255,.98),rgba(255,61,220,.72) 50%,rgba(29,210,255,.78));box-shadow:0 28px 70px rgba(151,62,255,.40),0 0 70px rgba(255,65,220,.20),inset 0 1px 0 rgba(255,255,255,.24);}
.ld_world_btn_main{font-size:clamp(15px,2vw,22px);letter-spacing:.11em;}.ld_world_btn_sub{font-size:clamp(10px,1.2vw,13px);letter-spacing:.08em;}
.ld_actionsRow_simple #ld_btn_checkin_hero{background:linear-gradient(135deg,rgba(15,10,35,.90),rgba(54,31,100,.82));border-color:rgba(218,168,255,.24);color:rgba(255,255,255,.88);}
.ld_cards{display:grid !important;grid-template-columns:minmax(0,680px) !important;justify-content:center;padding:20px clamp(16px,3vw,34px) 34px;}
.ld_card{background:linear-gradient(180deg,rgba(10,6,26,.72),rgba(6,4,16,.66));border-color:rgba(219,160,255,.16);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);}
.ld_card .top h4{font-size:22px;}.ld_card .top p{font-size:14px;color:rgba(245,240,255,.74);}
#ld_mnav{background:linear-gradient(180deg,rgba(6,3,18,0),rgba(6,3,18,.88),rgba(4,2,12,.98));}
.ld_mbtn{background:linear-gradient(180deg,rgba(23,12,52,.82),rgba(9,5,24,.88));border-color:rgba(218,168,255,.18);}
.ld_legal_footer{max-width:1320px;}
@media(max-width:860px){#ld_center .hero{min-height:640px;padding:22px 14px 28px;}#ld_center .hero::after{top:16px;font-size:9px;letter-spacing:.12em}.ld_iconic_hero{background-size:cover;background-position:center top;opacity:.92}.ld_world_microcopy{font-size:10px;line-height:1.45}.ld_cards{padding:14px 10px 24px}.ld_public_accordion{margin-bottom:10px}}
@media(max-width:560px){#ld_bg::before{background-position:center,center,center top;opacity:.44}#ld_top{border-radius:20px}.ld_brand_wordmark_main{font-size:clamp(24px,7.5vw,34px);letter-spacing:.07em}.ld_brand_wordmark_sub{font-size:clamp(11px,3.5vw,16px);letter-spacing:.18em}#ld_top_actions{grid-template-columns:1fr 1fr 1fr}#ld_top_actions .ld_btn{font-size:10px;min-height:42px;padding:8px 7px}.ld_top_legal_links a{font-size:9px;padding:7px 10px}#ld_center{border-radius:24px}#ld_center .hero{min-height:600px;border-radius:24px;justify-content:flex-end;padding:70px 12px 22px}.ld_iconic_hero{background-size:auto 63%;background-repeat:no-repeat;background-position:center 58px}.ld_centerTitle{font-size:clamp(34px,12vw,55px);line-height:.90}.ld_sub{font-size:14px}.ld_world_badge_line{font-size:9px;letter-spacing:.10em;padding:8px 10px;margin-bottom:10px}#ld_btn_world.ld_btn.world{min-height:80px;border-radius:24px;padding-left:14px;padding-right:48px}.ld_actionsRow_simple #ld_btn_checkin_hero{width:min(330px,92%);font-size:11px}.ld_card .top{flex-direction:column}.ld_card .top h4{font-size:19px}}
...
<div id="ld_shell">
  <div id="ld_top">
    ...
    <div id="ld_top_actions">
      <button class="ld_btn ghost compact" id="ld_btn_help" title="Info / Help" aria-label="Info and help">
        <span class="ld_help_text">INFO / HELP</span>
      </button>
      ...
      <button class="ld_btn ghost compact" id="ld_btn_login" title="Login or account" aria-label="Login or account">
        <span id="ld_login_label">LOGIN</span>
      </button>
  ...
  <details class="ld_public_accordion" aria-label="About LifeDecode AI">
    <summary>
      <span class="ld_public_summary_left">
        <span class="ld_public_kicker">World HQ</span>
        <span class="ld_public_summary_title">Daily Check-In, privacy & legal info</span>
        <span class="ld_public_summary_desc">The important stuff stays here. The world takes the stage.</span>
      </span>
    ...
    <div class="ld_public_body">
      <div class="ld_public_inner">
        ...
        <p>LifeDecode is becoming an interactive world first: a mysterious online space for characters, quests, growth, check-ins, lore, cosmetics, social moments and weird little chaos that somehow still makes you better at life.</p>
        <div class="ld_public_grid">
          <div class="ld_public_card"><b>Daily check-ins</b><p>Users can create focused daily check-ins to reflect, track mood, build consistency, and keep progress moving.</p></div>
          <div class="ld_public_card"><b>LifeDecode World</b><p>Enter the world directly from the landing page. No login wall before the landing. No nonsense.</p></div>
          <div class="ld_public_card"><b>Progress & XP</b><p>Daily check-ins, XP, streaks and future world rewards stay connected to the bigger LifeDecode experience.</p></div>
        </div>
        <div class="ld_public_data">
          <p><strong style="color:#fff;">Why LifeDecode requests user data:</strong> LifeDecode uses basic account information such as email, profile name, login provider, and session data to authenticate users, keep accounts secure, save progress, sync features across devices, prevent abuse, and provide personalized app functionality. Users can also voluntarily submit check-ins and reflections so the app can generate relevant AI-supported responses.</p>
        </div>
...
<button data-open="progress">🏆 Progress <small>Premium • Levels, milestones & rewards</small></button>
    ...
    <div class="ld_panel" id="ld_center">
      <div class="hero">
        ...
        <div class="ld_iconic_hero" aria-hidden="true"></div>

        <div class="ld_world_badge_line">Silly Squad is assembling</div>
        <div class="ld_centerTitle">
          Enter <span class="grad" id="ld_name_big">LifeDecode World</span>.
        </div>
        <div class="ld_sub" id="ld_subline">
          A mysterious browser world with spirits, quests, cosmetics, NPCs, social chaos, daily check-ins and hidden growth systems. Cute on the outside. Secretly deep as hell.
        </div>
        <div class="ld_world_microcopy">No login wall before landing • Privacy & terms stay available • Daily Check-In stays alive</div>

                <div class="ld_actionsRow ld_actionsRow_simple">
          <button class="ld_btn world" id="ld_btn_world" type="button"><span class="ld_world_btn_main">ENTER LIFEDECODE WORLD</span><span class="ld_world_btn_sub">Play, explore, meet NPCs, collect Dust & cause emotional damage</span></button>
        ...
        <div class="ld_card">
          <div class="top">
            <div>
              ...
              <h4>Daily Check-In stays</h4>
             <p>Quick reflection, streaks and XP stay here as the real-life progress layer behind the world.</p>
            </div>
          ...
          <div class="mid">
           ...
           <div class="ld_hint" id="ld_checkin_hint">Pick your mood, tap the trend, and write one clear update.</div>
          </div>
...
<div id="ld_ob" role="dialog" aria-modal="true" aria-label="Onboarding">
  <div class="hd">
    <div>
      ...
      <h3 style="margin:6px 0 0;"> Lab</h3>
    </div>
...
<div id="ld_auth" role="dialog" aria-modal="true" aria-label="Auth">
  <div class="hd">
    <div>
      ...
      <h3 style="margin:6px 0 0;">Login or create your account</h3>
    </div>
    <button class="ld_btn ghost compact" id="ld_auth_close" title="Close">Close</button>
  </div>
  <div class="bd">
    <div class="ld_auth_hero">
      <div class="ld_ob_title">Save your progress across devices</div>
      <p class="ld_ob_sub">Use an account to keep your streak, XP, check-ins, screenshot decodes, and premium access synced. Guest mode still works if you just want to test it first.</p>
      <div class="ld_goodbox">
        <strong>Fast entry:</strong> guest mode now, account later whenever you want to save everything.
      </div>
    </div>
