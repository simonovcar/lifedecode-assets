...
/* ===== TOP BRAND LOGO PATCH ===== */
#ld_top{padding:16px 18px;gap:14px;}
#ld_top_main{justify-content:center;}
#ld_brand{width:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:10px;text-align:center;}
#ld_brand_meta{align-items:center;justify-content:center;gap:4px;}
#ld_logo{display:none !important;}
#ld_logo_img{display:block;width:min(220px,72vw);max-width:220px;height:auto;object-fit:contain;filter:drop-shadow(0 10px 26px rgba(0,0,0,.32));}
.ld_brandname{font-family:Georgia, 'Times New Roman', serif;font-size:18px;font-weight:700;letter-spacing:.01em;max-width:none;color:#f7f4ff;}
.ld_brandtag{font-size:10px;letter-spacing:.20em;text-transform:uppercase;color:rgba(210,199,238,.62);font-weight:700;}
#ld_topnav{display:none !important;}
#ld_top_actions{grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;}
#ld_top_actions .ld_btn{min-height:46px;border-radius:16px;font-size:13px;font-weight:800;}
@media (max-width:560px){
  #ld_top{padding:12px;gap:12px;}
  #ld_top_main{gap:8px;}
  #ld_brand{gap:8px;}
  #ld_logo_img{width:min(180px,68vw);max-width:180px;}
  .ld_brandname{font-size:15px;}
  .ld_brandtag{font-size:9px;letter-spacing:.16em;}
  #ld_top_actions{gap:8px;}
  #ld_top_actions .ld_btn{min-height:42px;font-size:11px;border-radius:14px;padding:8px 10px;}
}
@media (max-width:430px){
  #ld_logo_img{width:min(160px,66vw);max-width:160px;}
  .ld_brandname{font-size:14px;}
  .ld_brandtag{font-size:8px;}
  #ld_top_actions .ld_btn{font-size:10px;}
}
...
<div id="ld_shell">
  <div id="ld_top">
    <div id="ld_top_main">
      <div id="ld_brand">
        <img id="ld_logo_img" src="https://i.imgur.com/sfjtIEz.jpeg" alt=" logo" loading="eager" referrerpolicy="no-referrer">
        <div id="ld_brand_meta">
          <span class="ld_brandname"></span>
      ...
      <div class="hero">
        ...
        <div class="ld_sub" id="ld_subline">
         A sharp AI companion for check-ins, emotional clarity, screenshot decoding, and the right next move when your head gets loud.
          ...
          <button class="ld_btn ghost" id="ld_btn_world">Enter Velvyria World</button>
        </div>
      </div>
...
if (styleChip) {
  ...
  return;
        ...
        if (e.target.closest("#ld_btn_world")) {
          openSheet("VELVYRIA WORLD", `
            <div class="ld_help_shell">
              <div class="ld_help_hero">
                <div class="kicker">VELVYRIA WORLD</div>
                <div class="ld_ob_title" style="margin:8px 0 6px;">IN CONSTRUCTION</div>
                <div class="ld_ob_sub">Velvyria World is being built right now. The world layer, social map, and game systems are not live yet.</div>
              </div>
            </div>
          `);
          return;
