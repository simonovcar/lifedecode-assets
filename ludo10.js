        ...
        <div class="ld_card">
          <div class="top">
            <div>
             ...
             <p>A quick daily reset to log your state and keep momentum.</p>
            </div>
          ...
          <div class="mid">
           ...
           <div class="ld_hint" id="ld_checkin_hint">Pick the mood, choose the trend, and write one clean update.</div>
          </div>
  ...
  openSheet(
    ...
    `
      <div style="max-width:760px;margin:0 auto;">
        ...
        <div class="ld_hint">Pick your mood, choose the trend, then write one clean message about what is going on right now.</div>
        ...
        <div class="ld_hint">How is it moving?</div>
        ...
        <textarea class="ld_field" id="ld_ci_situation" placeholder="What is going on right now? Example: I woke up anxious and keep overthinking. Or: I feel numb and keep scrolling instead of moving."></textarea>
...
Now keep it simple: do "${nextStep || "one small clean action"}" next.`;
    ...
    function buildScreenshotFallback(context, tone) {
      ...
      return `READ:
Mixed or uneven energy. Someone here is leaving room for ambiguity instead of giving clean clarity.

MEANING:
This usually points to hesitation, lower interest, emotional distance, or a desire to keep control without fully committing.

NEXT MOVE:
Stay calm, do not chase, and answer briefly with self-respect. Let their effort reveal the truth.
...
${ctx || "General screenshot decode."}`;
    ...
    async function generateScreenshotDecode({ imageDataUrl, context, tone, previewOnly }) {
      ...
      const payload = {
        ...
        prompt: `You are LifeDecode Screenshot Decoder AI.
Read the screenshot directly. Most screenshots are chats, texts, or DMs.
Sound human, sharp, confident, socially aware, and a little spicy when it fits. If the situation is serious, stay serious.
...
- No therapy disclaimers.
- No robotic wording.
- If unreadable, say: "Need a cleaner screenshot."
...
Hard cap: 95 words total.

Make it feel real, direct, and useful.`
      };
      const reply = await callMake(payload);
