(function () {
  ...
  const CFG = {
    VERSION: "lifedecode-app-v10-vertical-rhythm-fix",
...
/* Sections — padding is intentionally asymmetric (bigger top, small bottom).
...
.ldw_section{padding:clamp(48px,6vw,104px) 0 clamp(20px,2.5vw,40px);border-top:1px solid rgba(255,255,255,.05);}
.ldw_section_legal{padding-top:clamp(32px,3.5vw,56px);padding-bottom:clamp(20px,2.5vw,32px);}
...
/* Cosmetics */
.ldw_cosmetics{display:grid;grid-template-columns:1.1fr .9fr;gap:clamp(24px,4vw,40px);align-items:center;}
...
<div class="ldw_shell">
  <main>
    ...
    <section class="ldw_section ldw_section_legal ldw_container" aria-label="Privacy and legal">
