(function () {
  ...
  const CFG = {
    VERSION: "lifedecode-app-v11-hero-support-legal",
...
<div class="ldw_shell">
  <main>
    ...
    <section class="ldw_section ldw_section_cta ldw_container">
...
<div class="ldw_support" id="ldw_support">
  <div class="ldw_support_panel" id="ldw_support_panel" role="dialog" aria-modal="false" aria-labelledby="ldw_support_title">
    <div class="ldw_support_head">
      <div>
        ...
        <p class="ldw_support_sub">Send us a message — we'll reply to the email you give us.</p>
      </div>
  ...
  <button class="ldw_support_toggle" id="ldw_support_toggle" type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="ldw_support_panel" aria-label="Open support chat" aria-describedby="ldw_support_tooltip">
    <span class="ldw_support_tooltip" id="ldw_support_tooltip" role="tooltip">Need help?</span>
