...
const flap = -470;
      ...
      function updateRewardUI() {
        if (reward10El) {
          reward10El.textContent = STATE.minigame?.rewardsClaimed?.score10 ? "CLAIMED" : `+${CFG.XP.GAME_10} XP @ 10`;
        }
        if (reward20El) {
          reward20El.textContent = STATE.minigame?.rewardsClaimed?.score20 ? "CLAIMED" : `+${CFG.XP.GAME_20} XP @ 20`;
        }
      }
