...
<div id="ld_shell">
  <div id="ld_top">
    <div id="ld_top_main">
      <div id="ld_brand">
        <img id="ld_logo_img" src="https://i.imgur.com/ktfHXUy.png" alt="LifeDecode logo" loading="eager" referrerpolicy="no-referrer">
...
${ctx || "General screenshot decode."}`;
    ...
    async function generateScreenshotDecode({ imageDataUrl, context, tone, previewOnly }) {
      ...
      const payload = {
        ...
        prompt: `You are LifeDecode Screenshot Decoder.
