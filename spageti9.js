...
#ld_logo{
  ...
  background:
    ...
    linear-gradient(135deg, #5ee7ff 0%, #7a5cff 48%, #ff4fd8 100%);
  box-shadow:
    0 10px 28px rgba(94,110,255,.30),
...
.ld_mbtn.active{
  background:
    linear-gradient(135deg, rgba(122,92,255,.72), rgba(34,211,238,.34));
  color:var(--txt);
  border-color:rgba(255,255,255,.18);
  box-shadow:
    0 18px 34px rgba(88,78,255,.22),
...
const premiumModules = ["journal", "insights", "progress", "tools"];
