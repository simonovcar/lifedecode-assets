  ...
  <details class="ld_public_accordion" aria-label="About LifeDecode AI">
    <summary>
      <span class="ld_public_summary_left">
        ...
        <span class="ld_public_summary_title">About LifeDecode AI</span>
        <span class="ld_public_summary_desc">Purpose, data usage, privacy and terms.</span>
      </span>
    ...
    <div class="ld_public_body">
      <div class="ld_public_inner">
        <h1>LifeDecode AI</h1>
        <p>LifeDecode AI is an AI-powered self-development and emotional clarity platform. It helps users reflect through daily check-ins, track progress, and enter the interactive Velvyria World experience.</p>
        <div class="ld_public_grid">
          ...
          <div class="ld_public_card"><b>Velvyria World</b><p>Users can enter the interactive LifeDecode world experience directly from the dashboard.</p></div>
          <div class="ld_public_card"><b>Progress tracking</b><p>The app keeps the experience centered around streaks, XP, account sync, and simple self-development flow.</p></div>
        </div>
      ...
      <div class="hero">
        ...
        <div class="ld_sub" id="ld_subline">
         A sharp AI companion for daily check-ins, progress, and the Velvyria World experience.
          ...
          <button class="ld_btn world" id="ld_btn_world" type="button"><span class="ld_world_btn_main">ENTER VELVYRIA WORLD</span><span class="ld_world_btn_sub">Explore the interactive LifeDecode world</span></button>
          <button class="ld_btn primary" id="ld_btn_checkin_hero" data-open="checkin">New Check-In</button>
        </div>
      </div>
        ...
        <div class="ld_card">
          <div class="top">
            <div>
             ...
             <p>One fast daily check-in to keep your head clear and your streak alive.</p>
            </div>
