...
@media (max-width:860px){
  ...
  .ld_actionsRow .ld_btn:nth-child(1){ grid-column:1 / -1; }
  .ld_actionsRow .ld_btn:nth-child(2){ grid-column:1 / -1; }
  ...
  .ld_card{ border-radius:26px; }
  .ld_brain{ height:110px; }
...
@media (max-width:860px){
  #ld_center .ld_cards > .ld_card:nth-child(4){
    display:none;
  }
...
<div id="ld_mnav" role="navigation" aria-label="Quick modules">
  <div class="row">
    <button class="ld_mbtn" data-open="dashboard" type="button">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M3 11.5 12 4l9 7.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5 10.5V20h14v-9.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
      <span>Home</span>
    </button>
    ...
    <button class="ld_mbtn" data-open="coach" type="button">
    ...
    <button class="ld_mbtn" id="ld_mbtn_menu" type="button">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M4 7h16M4 12h16M4 17h16" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path></svg>
      <span>Menu</span>
    </button>
  </div>
</div>
...
`;
 ...
 function injectCSS() {
  ...
  function renderHTML() {
    ...
    app.innerHTML = HTML;
    document.body.classList.remove("ld_record_mode");
    return true;
  }
  ...
  function startWhenReady() {
    ...
    const timer = setInterval(() => {
      ...
      if (app) {
        ...
        renderHTML();
        try {
          const staleMenu = document.getElementById("ld_mmenu");
          const staleBackdrop = document.getElementById("ld_mmenu_backdrop");
          if (staleMenu) staleMenu.style.display = "none";
          if (staleBackdrop) staleBackdrop.style.display = "none";
          initLifeDecode();
        } catch (err) {
