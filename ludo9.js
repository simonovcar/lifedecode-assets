...
Read the screenshot directly. Most screenshots are chats or messages.
Be charismatic, sharp, socially smart, and premium. Be funny only when the screenshot naturally allows it. Be serious when the screenshot is serious.
...
- No generic filler.
- No tone labels.
- If the screenshot is unreadable, say that briefly and ask for a cleaner crop.
...
REPLY:
[one short reply only if useful]

Hard cap: 140 words total.

Always sound specific, confident, and useful.`
      };
      const reply = await callMake(payload);
      ...
      openSheet(
        ...
        <div class="ld_sd_shell">
          <div class="ld_sd_hero">
            ...
            <div class="ld_sd_sub">Upload a screenshot and get a sharp read on the signal, hidden meaning, red flags, and the cleanest next move.</div>
              ...
              <div class="bd">
                <label class="ld_sd_upload ${shot.lastImageData ? "has-image" : ""}" id="ld_sd_upload_box">
                  ...
                  <div class="ld_sd_uploadInner">
                    ...
                    <div class="ld_sd_sub" style="max-width:34ch;">Best for chats, texts, DMs, mixed signals, ghosting, or weird replies.</div>
                  </div>
                ...
                <div class="ld_hint" id="ld_sd_hint">One free preview per day. Unlock gives the full read and a reply suggestion.</div>
              </div>
            </div>
